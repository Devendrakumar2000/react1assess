...
function App() {
  ...
  return (
    <div className="styling">
      ...
      <button onClick={() => functionBased()} className="function">
        {" "}
        Div by using Functional Component{" "}
      </button>
      <button onClick={() => classBased()} itemID="class">
        {" "}
        Div by using Class Component{" "}
      </button>{" "}
      {/* <Functionbased /> */} {show.state && <Functionbased />}{" "}
